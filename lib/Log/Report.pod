...
=item B<dispatcher>((TYPE, OPTIONS)|(COMMAND => NAME, [NAMEs]))
...
This module is part of Log-Report distribution version 0.91,
built on January 26, 2011. Website: F<http://perl.overmeer.net/log-report/>
