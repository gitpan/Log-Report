...
Log::Report::Dispatcher-E<gt>B<new>(TYPE, NAME, OPTIONS)
...
Log::Report::Dispatcher-E<gt>B<stackTraceLine>(OPTIONS)
...
using concatenation (see L<Log::Report::Message::concat()|Log::Report::Message/"Accessors">.

I<Example:> a filter on syslog
...
I<Example:> take all mistakes and warnings serious
...
This module is part of Log-Report distribution version 0.06,
built on June 09, 2007. Website: F<http://perl.overmeer.net/log-report/>
