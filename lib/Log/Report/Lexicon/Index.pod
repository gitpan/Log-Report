...
Log::Report::Lexicon::Index-E<gt>B<new>(DIRECTORY, OPTIONS)
...
$obj-E<gt>B<addFile>(BASENAME, [ABSOLUTE])
...
$obj-E<gt>B<find>(TEXTDOMAIN, LOCALE)
...
I<Example:> lexicon in module tree
