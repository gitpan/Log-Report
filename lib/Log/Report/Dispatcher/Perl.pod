...
Log::Report::Dispatcher::Perl-E<gt>B<new>(TYPE, NAME, OPTIONS)
...
Log::Report::Dispatcher::Perl-E<gt>B<collectLocation>
...
Log::Report::Dispatcher::Perl-E<gt>B<stackTraceLine>(OPTIONS)
...
This module is part of Log-Report distribution version 0.15,
built on February 25, 2008. Website: F<http://perl.overmeer.net/log-report/>
