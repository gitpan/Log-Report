...
See L<documentation in the base class|Log::Report::Minimal::Domain/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in the base class|Log::Report::Minimal::Domain/"METHODS">.
 
=head2 Constructors

See L<documentation in the base class|Log::Report::Minimal::Domain/"Constructors">.
...
See L<documentation in the base class|Log::Report::Minimal::Domain/"Attributes">.
...
See L<Log::Report::Minimal::Domain/"Attributes">
...
See L<documentation in the base class|Log::Report::Minimal::Domain/"Action">.
 
=over 4

=item Log::Report::Domain-E<gt>B<interpolate>(MSGID, [ARGS])

See L<Log::Report::Minimal::Domain/"Action">
...
This module is part of Log-Report distribution version 1.00,
